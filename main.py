...
from handlers import concurrent_txt_handler
from thanos import *
...
async def txt_handler(bot: Client, m: Message):
    # Redirect to new concurrent handler
    await concurrent_txt_handler(bot, m, auto_flags)
    return

async def old_txt_handler(bot: Client, m: Message):  
    # Get bot username
